...
router.post('/api/coupons/apply', async (req, res) => {
    ...
    return res.status(200).json({
        ...
        coupon: {
            ...
            type: coupon.type,
            value: coupon.value,
            shoofiDiscount: coupon.shoofiDiscount,
            storeDiscount: coupon.storeDiscount,
...
router.post('/api/admin/coupon/create', upload.array("img"), async (req, res) => {
    ...
    const couponDoc = {
        ...
        shoofiDiscount: getFieldValue('shoofiDiscount') ? parseFloat(getFieldValue('shoofiDiscount')) : null,
        storeDiscount: getFieldValue('storeDiscount') ? parseFloat(getFieldValue('storeDiscount')) : null,
